classdef PathChecker < handle
    ...
    methods
        ...
        function self = PathChecker(robot, obstaclesProcessor)
            ...
            self.robot = robot;
            self.obstaclesProcressor = obstaclesProcessor;
    ...
    methods (Static)
        ...
        function [intersectionPoint, check] = LineLineIntersection(point1OnLine1,point2OnLine1,point1OnLine2,point2OnLine2)
        end
